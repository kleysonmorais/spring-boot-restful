...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.springlearn.project.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Esta API é utilizada para aprendizagem",
                "Versão 1.0",
                "https://site.com.br",
                new Contact("Kleyson Morais", "site.com.br", "kleysondev@gmail.com"),
